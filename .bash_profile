...
alias wp='warun "(app|src|tests|database)/**/*.php" -- "vendor/bin/phpunit" --verbose --no-coverage $*'
alias wpf='warun "(app|src|tests|database)/**/*.php" -- "vendor/bin/phpunit" --verbose --no-coverage --filter $*'
alias wpcf='warun "(app|src|tests|database)/**/*.php" -- "vendor/bin/phpunit" --verbose --filter $*'
